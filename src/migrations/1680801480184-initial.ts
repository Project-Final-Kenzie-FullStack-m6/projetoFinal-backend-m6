...
export class initial1680801480184 implements MigrationInterface {
  name = "initial1680801480184";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "comments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "content" character varying(255) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, "adversimentId" uuid, CONSTRAINT "PK_8bf68bc960f2b69e818bdb90dcb" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "images" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "imageUrl" character varying(255) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "adversimentsId" uuid, CONSTRAINT "PK_1fe148074c6a1a91b63cb9ee3c9" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "adversiments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "brand" character varying(50) NOT NULL, "model" character varying(50) NOT NULL, "age" integer NOT NULL, "fuelType" character varying(10) NOT NULL, "mileAge" integer NOT NULL, "price" integer NOT NULL, "color" character varying(20) NOT NULL, "fipe" integer NOT NULL, "isActive" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, CONSTRAINT "PK_de05d0b0589bf134e051c3fbcba" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "comments" ADD CONSTRAINT "FK_54d83c7cca1b9d9fe9b21858a0d" FOREIGN KEY ("adversimentId") REFERENCES "adversiments"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "images" ADD CONSTRAINT "FK_27983224ef2c1cdbf75c2e40d47" FOREIGN KEY ("adversimentsId") REFERENCES "adversiments"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "adversiments" ADD CONSTRAINT "FK_154ebc678f6247904b4cca68601" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "adversiments" DROP CONSTRAINT "FK_154ebc678f6247904b4cca68601"`
    );
    await queryRunner.query(
      `ALTER TABLE "images" DROP CONSTRAINT "FK_27983224ef2c1cdbf75c2e40d47"`
    );
    await queryRunner.query(
      `ALTER TABLE "comments" DROP CONSTRAINT "FK_54d83c7cca1b9d9fe9b21858a0d"`
    );
    await queryRunner.query(
